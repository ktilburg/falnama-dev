...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/kitchen/10_it-all-starts-with-FAIR-data.ipynb.

# %% auto 0
__all__ = ['Falnama_maxrf_data']

# %% ../nbs/kitchen/10_it-all-starts-with-FAIR-data.ipynb 20
import pooch
import tqdm
from glob import glob

# %% ../nbs/kitchen/10_it-all-starts-with-FAIR-data.ipynb 21
