# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/functions/20_a-dashboard-for-exploring-our-maxrf-data.ipynb.

# %% auto 0
__all__ = ['Dashboard']

# %% ../nbs/functions/20_a-dashboard-for-exploring-our-maxrf-data.ipynb 19
import maxrf4u
